...
function makeManager(
  overrides: Partial<MockTransactionManager> = {},
...
function makeDataSource(manager: MockTransactionManager): DataSource {
  return {
    transaction: jest.fn(
      (cb: (manager: MockTransactionManager) => Promise<unknown>) =>
        cb(manager),
    ),
